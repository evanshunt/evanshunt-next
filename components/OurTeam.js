    ...
    <section className="our-team">
      ...
      <div className="our-team-leaders">
        {leaders && leaders.map((leader, i) => {
          return (
            <div className="our-team-leader" key={i}>
...
const TitleAndLogo = ({title}) => {
  ...
  return (
    <div className="our-team-title">
      {/*  an svg or the h1 solution below would be preferable, but the alignment is super weird   */}
      <img src="/images/our-team-logo.jpg" className="img-fluid" alt="Our team logo" /> 
      
      {/*<h1>*/}
      {/*  <span>{titleParts[0]}</span>*/}
      {/*  <svg width="134px" height="134px" viewBox="0 0 81 80" version="1.1" id="footer-logo">*/}
