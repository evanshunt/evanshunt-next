...
const ServiceBlock = (props) => {
  ...
  const serviceClass = props.title
    .toString()
    .toLowerCase()
  ...
  return (
    <div className="service-block-text">
      ...
      <div className="service-block-copy">
        ...
        {servicesList && (
          <ul className="service-block-services">
            {servicesList.map((service, i) => {
              return (
                <li className="service-block-service" key={i}>
                  {service}
                </li>
              );
            })}
        ...
        {link && (
          <Link href={link.fields.url} legacyBehavior>
            <a
    ...
    if (imgTrigger.current != null) {
      ...
      tl.current
        .fromTo(
          imgBg.current,
          { opacity: 0, y: 50 },
          { duration: 1, opacity: 1, y: 0, ease: "power4.out" },
          "bgIn"
        )
        .fromTo(
          imgRight.current,
    ...
    <div ref={imgTrigger} className="service-block-img">
      {imageBackground && (
        <div className="img-background">
          <picture>
            <source
              srcSet={`${imageBackground.fields.file.url}?fm=webp`}
              type="image/webp"
            />
            <source
              srcSet={`${imageBackground.fields.file.url}`}
              type="image/jpeg"
            />
            <img
              ref={imgBg}
      ...
      {imageForegroundRight && (
        <div className="img-right-side">
          <picture>
            <source
              srcSet={`${imageForegroundRight.fields.file.url}?fm=webp`}
              type="image/webp"
            />
            <source
              srcSet={`${imageForegroundRight.fields.file.url}`}
              type="image/jpeg"
            />
            <img
              ref={imgRight}
      ...
      {imageForegroundLeft && (
        <div className="img-left-side">
          <picture>
            <source
              srcSet={`${imageForegroundLeft.fields.file.url}?fm=webp`}
              type="image/webp"
            />
            <source
              srcSet={`${imageForegroundLeft.fields.file.url}`}
              type="image/jpeg"
            />
            <img
              ref={imgLeft}
